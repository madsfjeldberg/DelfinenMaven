...
public class FileHandlerTest {
    ...
    void saveMemberList() {
        ...
        Member member1 = new Member("John", "john@doe", true, LocalDate.of(1990, 1, 1), LocalDate.of(2022, 2, 2),12345678);
        Member member2 = new Member("Jane", "jane@doe", false, LocalDate.of(1995, 5, 5), LocalDate.of(2021, 1, 1),12345678);
